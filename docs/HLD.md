...
**왕관은 King's Crown을 직접 그린 것**이지 컬럼비아 트레이드마크 파일을 가져온 게 아니다 — 비공식 학생 페이지라 공식 마크를 쓰면 승인받은 것처럼 보인다. 구성: 밑단 가로바, 잎 모양이 뚫린 두 날개, 중앙 기둥, 구슬, 십자가. 실물을 참고해 실루엣만 단순화했다(초기에 넣었던 지그재그 세 봉우리는 King's Crown이 아니라 그냥 파티 모자였다).
